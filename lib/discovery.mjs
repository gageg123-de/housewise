...
const locationDefinitions = [
  { value: "bathroom", label: "Bathroom", locations: ["bathroom"], systems: ["plumbing", "bathroom", "moisture-and-mold"], symptoms: [
    ...
    { value: "drainage", label: "Slow drain, backup, or clogging", articleSymptoms: ["drainage", "clogging"] },
  ...
  { value: "laundry", label: "Laundry area", locations: ["laundry"], systems: ["appliances", "plumbing", "electrical"], symptoms: [
    { value: "appliance-behavior", label: "Washer or dryer behavior", articleSymptoms: ["appliance-behavior", "heat"] },
  ...
  { value: "attic", label: "Attic", locations: ["attic"], systems: ["attic-and-insulation", "hvac", "roofing", "pests"], symptoms: [
    { value: "moisture", label: "Moisture, condensation, or staining", articleSymptoms: ["moisture", "leaking", "discoloration"] },
  ...
  return articles
    .map((article) => {
      ...
      for (const term of terms) {
        ...
        score += titleMatch ? 12 : keywordMatch ? 9 : taxonomyMatch ? 7 : bodyMatch ? 3 : fuzzyMatch ? 2 : 0;
      }

      const requiredMatches = terms.length === 1 ? 1 : Math.ceil(terms.length * 0.75);
