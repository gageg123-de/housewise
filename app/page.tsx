...
export default function Home() {
  ...
  return <SiteShell><section className="hero"><p className="eyebrow">Practical answers for puzzling homes</p><h1>Figure out what’s happening in your home.</h1><p className="hero-copy">Search a symptom, browse a system, or use the guided problem finder to narrow down what to check next.</p><form className="search-box" action="/search/"><label className="sr-only" htmlFor="site-search">Search home problems</label><input id="site-search" name="q" type="search" placeholder="Try “toilet bubbling” or “warm outlet”"/><button type="submit">Search guides</button></form><Link className="finder-link" href="/find-a-problem/">Not sure what to search? Start the Problem Finder →</Link></section>
