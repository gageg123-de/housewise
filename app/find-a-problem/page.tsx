...
const description = "Choose a location and symptom to find relevant homeowner guides.";
export const metadata: Metadata = { title: "Home Problem Finder", description, alternates: { canonical: canonicalUrl("/find-a-problem/") }, openGraph: { title: "Home Problem Finder", description, url: canonicalUrl("/find-a-problem/"), images: [] }, twitter: { title: "Home Problem Finder", description, images: [] } };
